...
img = cv2.imread("majorproject/Data/Data/Frames/video79/frame189.jpg")
cv2.imwrite("t.jpg",img)
model = tf.keras.models.load_model('/users/gowtham/downloads/majorproject/savedmodels/approach_3_2')
